...
//         }
//
//         public async Task<ResponseModel<List<Cliente>>> GetAllClients(int idUser)
//         {
//             ResponseModel<List<Cliente>> respost = new ResponseModel<List<Cliente>>();
//
//             try
//             {
...
//         }
//
//         public async Task<ResponseModel<Cliente>> CriarCliente(CriarClienteDto pCliente)
//         {
//
...
//         }
//
//         public async Task<ResponseModel<Cliente>> UpdateClient(int clientId, ClientUpdateDto clientUpdateDto)
//         {
//             ResponseModel<Cliente> respost = new ResponseModel<Cliente>();
//
//             try
//             {
...
//         }
//
//         public async Task<ResponseModel<Cliente>> DeleteClient(int idClient)
//         {
//             ResponseModel<Cliente> respost = new ResponseModel<Cliente>();
//
//             try
